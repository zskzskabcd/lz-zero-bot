...
import (
	...
	// chat ai
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/chat_ai"
...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:8090", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "lzBot", "Set default nickname.")
